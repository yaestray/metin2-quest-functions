...
Подробнее о том, сколько значений и вообще что возвращает функция, можно узнать из статьи о ней &mdash; на этом сайте задокументировано большинство квестовых функций.
