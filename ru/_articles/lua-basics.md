...
Выше был показал пример использования глобальной переменной. Существуют еще локальные переменные, которые задаются с помощью ключевого слова `local`:
...
В Lua существует несколько типов данных. В примерах выше мы использовали только числа, но существует еще несколько:
